...
export const GameErrorScreen = memo(function GameErrorScreen({
  ...
  return (
    <View style={styles.container} testID="gameErrorScreen">
      ...
      <TouchableOpacity testID="gameRetryButton" style={styles.retryButton} onPress={onRetry}>
        <Text style={styles.retryButtonText}>Try Again</Text>
      </TouchableOpacity>
      <TouchableOpacity testID="gameGoHomeButton" style={styles.goHomeButton} onPress={onGoHome}>
