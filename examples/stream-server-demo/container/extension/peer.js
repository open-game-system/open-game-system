(() => {
  ...
  class n {
    constructor() {
      (this.chunkedMTU = 16300), // The original 60000 bytes setting does not work when sending data from Firefox to Chrome, which is "cut off" after 16384 bytes and delivered individually. // Binary stuff
        (this._dataCount = 1),
        (this.chunk = (e) => {
          let t = [],
            n = e.byteLength,
            ...
            o = 0;
          for (; o < n; ) {
            const s = Math.min(n, o + this.chunkedMTU),
              a = e.slice(o, s),
  ...
  class s {
    ...
    unpack_uint64() {
      const e = this.read(8),
        t =
          ((((((256 * e[0] + e[1]) * 256 + e[2]) * 256 + e[3]) * 256 + e[4]) * 256 + e[5]) * 256 +
            e[6]) *
            256 +
          e[7];
    ...
    unpack_string(e) {
      ...
      for (; i < e; )
        (t = r[i]) < 160 // One-byte sequence: bits 0xxxxxxx
          ? ((n = t), i++)
          : (192 ^ t) < 32 // Two-byte sequence: bits 110xxxxx 10xxxxxx
            ? ((n = ((31 & t) << 6) | (63 & r[i + 1])), (i += 2))
            : (224 ^ t) < 16 // Three-byte sequence: bits 1110xxxx 10xxxxxx 10xxxxxx
    ...
    unpack_float() {
      const e = this.unpack_uint32();
      return (
        (0 === e >> 31 ? 1 : -1) * ((8388607 & e) | 8388608) * 2 ** (((e >> 23) & 255) - 127 - 23)
      );
    }
    unpack_double() {
      const e = this.unpack_uint32(),
        ...
        n = ((e >> 20) & 2047) - 1023;
      return (
        (0 === e >> 31 ? 1 : -1) * (((1048575 & e) | 1048576) * 2 ** (n - 20) + t * 2 ** (n - 52))
      );
    }
    read(e) {
      const t = this.index;
  ...
  class a {
    ...
    pack(e) {
      if ("string" === typeof e) this.pack_string(e);
        ...
        if (null === e) this._bufferBuilder.append(192);
          ...
          if (Array.isArray(e)) this.pack_array(e);
    ...
    pack_string(e) {
      const t = this._textEncoder.encode(e),
        n = t.length;
    ...
    pack_double(e) {
      let t = 0;
      e < 0 && ((t = 1), (e = -e));
      const n = Math.floor(Math.log(e) / Math.LN2),
        r = e / 2 ** n - 1,
    ...
    pack_object(e) {
      ...
      for (const t in e) Object.hasOwn(e, t) && (this.pack(t), this.pack(e[t]));
    }
    pack_uint8(e) {
    ...
    const r = (e) => {
        ...
        return (
          Object.keys(e).forEach((n) => {
            ...
            const i = (e, t) =>
              e ? e + t.charAt(0).toUpperCase() + t.slice(1) : "deviceId" === t ? "sourceId" : t;
            if (void 0 !== r.ideal) {
        ...
        if (e && "object" === typeof e.video) {
          ...
          if (
            ...
            ("user" === o.exact ||
              ...
              "user" === o.ideal ||
              "environment" === o.ideal) &&
            !(n.mediaDevices.getSupportedConstraints?.().facingMode && !s)
          ) {
            let t;
            if (
  ...
  function A(e, t) {
    if (
      ...
      e.navigator.mediaDevices.getDisplayMedia = (n) =>
        t(n).then((t) => {
          const r = n.video?.width,
            i = n.video?.height,
            o = n.video?.frameRate;
          return (
            (n.video = {
  ...
  function z(e) {
    ...
    if (
      ...
      if (!e.RTCPeerConnection.prototype.getSenders) {
        ...
        e.RTCPeerConnection.prototype.addTrack = function (e, _r) {
  ...
  function U(e) {
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      const [e, n, r] = arguments; // If selector is a function then we are in the old style stats so just
      ...
      const i = (e) => {
        ...
        o = (e) => new Map(Object.keys(e).map((t) => [t, e[t]]));
    ...
    if (!("getStats" in e.RTCRtpReceiver.prototype)) {
      ...
      t &&
        ...
        (e.RTCRtpReceiver.prototype.getStats = function () {
          return this._pc.getStats().then((t) => y(t, this.track, !1));
        });
    }
    if (!("getStats" in e.RTCRtpSender.prototype && "getStats" in e.RTCRtpReceiver.prototype))
      return; // shim RTCPeerConnection.getStats(track).
    const t = e.RTCPeerConnection.prototype.getStats;
    e.RTCPeerConnection.prototype.getStats = function () {
  ...
  function $(e) {
    ...
    e.RTCPeerConnection.prototype.addTrack = function (_e, n) {
  ...
  function J(e, t) {
    ...
    const i = e.RTCPeerConnection.prototype.removeStream; // replace the internal stream id with the external one and
    // vice versa.
    function o(e, t) {
      let n = t.sdp;
      return (
      ...
      (e.RTCPeerConnection.prototype.removeTrack = function (e) {
        ...
        (this._streams = this._streams || {}),
          Object.keys(this._streams).forEach((n) => {
            const r = this._streams[n].getTracks().find((t) => e.track === t);
            r && (t = this._streams[n]);
          }),
          t &&
  ...
  function H(e, t) {
    ...
    if (
      ...
      if (r?.prototype.applyConstraints) {
        const t = r.prototype.applyConstraints;
        r.prototype.applyConstraints = function (n) {
          return (
            "audio" === this.kind &&
              "object" === typeof n &&
              (e((n = JSON.parse(JSON.stringify(n))), "autoGainControl", "mozAutoGainControl"),
    ...
    (e.navigator.mediaDevices && "getDisplayMedia" in e.navigator.mediaDevices) ||
      ...
      (e.navigator.mediaDevices.getDisplayMedia = (n) => {
        if (!n?.video) {
          ...
          return (
            (e.name =
              "NotFoundError"), // from https://heycam.github.io/webidl/#idl-DOMException-error-names
            (e.code = 8),
            Promise.reject(e)
          );
        }
  ...
  function et(e) {
    ...
    t &&
      (e.RTCPeerConnection.prototype.addTransceiver = function () {
        ...
        let e = arguments[1]?.sendEncodings;
        void 0 === e && (e = []), (e = [...e]);
        const n = e.length > 0;
        n &&
          e.forEach((e) => {
  ...
  function er(e) {
    ...
    e.RTCPeerConnection.prototype.createOffer = function () {
      return this.setParametersPromises?.length
            ...
            this.addEventListener(
              ...
              (this._onaddstreampoly = (t) => {
                t.streams.forEach((t) => {
                  ...
                  (n.stream = t), this.dispatchEvent(n);
                });
              }),
            ),
          t.apply(this, arguments)
  ...
  function el(e) {
    const t = e?.navigator;
    if (t.mediaDevices?.getUserMedia) {
  ...
  function e_(e) {
    ...
    (e.RTCIceCandidate = (e) => {
      if (
        ...
        for (const e in i) e in r || Object.defineProperty(r, e, { value: i[e] });
        return (
      ...
      (e.RTCIceCandidate.prototype =
        n.prototype), // Hook up the augmented candidate in onicecandidate and
  ...
  function eC(e) {
    !e.RTCIceCandidate ||
      (e.RTCIceCandidate && "relayProtocol" in e.RTCIceCandidate.prototype) || // Hook up the augmented candidate in onicecandidate and
      // addEventListener('icecandidate', ...)
      d(e, "icecandidate", (e) => {
        if (e.candidate) {
          const n = /*@__PURE__*/ t(eg).parseCandidate(e.candidate.candidate);
  ...
  function ev(e, n) {
    ...
    const r = (e) => {
        if (!e || !e.sdp) return !1;
        const n = /*@__PURE__*/ t(eg).splitSections(e.sdp);
        return (
          n.shift(),
          n.some((e) => {
            const n = /*@__PURE__*/ t(eg).parseMLine(e);
      ...
      i = (e) => {
        ...
        const n = parseInt(t[1], 10); // Test for NaN (yes, this is ugly)
        return n !== n ? -1 : n;
      },
      o = (e) => {
        ...
        let t = 65536;
        return (
          "firefox" === n.browser && // fragmentation.
            (t =
              n.version < 57
                ? -1 === e
                  ? 16384
      ...
      s = (e, r) => {
        ...
        const o = /*@__PURE__*/ t(eg).matchPrefix(e.sdp, "a=max-message-size:");
        return (
          o.length > 0
            ? (i = parseInt(o[0].substring(19), 10))
            : "firefox" === n.browser &&
              -1 !== r && // both local and remote are Firefox, the remote peer can receive
              // ~2 GiB.
              (i = 2147483637),
          i
        );
      ...
      if (r(arguments[0])) {
        ...
        e =
          0 === n && 0 === r
            ...
            : 0 === n || 0 === r
              ? Math.max(n, r)
              : Math.min(n, r); // Create a dummy RTCSctpTransport object and the 'maxMessageSize'
        // attribute.
        const a = {};
  ...
  function eT(e, t) {
    ...
    if (!e.RTCPeerConnection?.prototype) return;
      ...
      (e.RTCPeerConnection.prototype.addIceCandidate = function () {
        return arguments[0]
          ? (("chrome" === t.browser && t.version < 78) ||
            ...
            ? Promise.resolve()
            : n.apply(this, arguments)
          : (arguments[1]?.apply(null), Promise.resolve());
      });
  }
  function eR(e, _t) {
    if (!e.RTCPeerConnection?.prototype) return;
  ...
  (ey.generateIdentifier = () =>
    ...
    (ey.localCName =
      ey.generateIdentifier()), // Splits SDP into lines, dealing with both CRLF and LF.
    (ey.splitLines = (e) =>
      e
        .trim()
        .split("\n")
    ...
    (ey.getDescription = (e) => {
      const t = ey.splitSections(e);
      return t?.[0];
    }), // Returns the individual media sections.
    (ey.getMediaSections = (e) => {
      const t = ey.splitSections(e);
      return t.shift(), t;
    ...
    (ey.parseRtpMap = (e) => {
      ...
      return (
        ...
        (n.channels =
          3 === t.length
            ? parseInt(t[2], 10)
            : 1), // legacy alias, got renamed back to channels in ORTC.
        ...
        e.rtcpFeedback?.length &&
          e.rtcpFeedback.forEach((e) => {
            t +=
              ...
              " " +
              e.type +
              (e.parameter?.length ? ` ${e.parameter}` : "") +
              "\r\n";
          }),
        t
      );
    ...
    (ey.parseSsrcMedia = (e) => {
      ...
      return (
        r > -1
          ? ((n.attribute = e.substring(t + 1, r)), (n.value = e.substring(r + 1)))
    ...
    (ey.parseRtpParameters = (e) => {
      ...
      const i = ey.matchPrefix(e, "a=rtcp-fb:* ").map(ey.parseRtcpFb); // FIXME: parse rtcp.
      return (
        t.codecs.forEach((e) => {
          i.forEach((t) => {
            const n = e.rtcpFeedback.find((e) => e.type === t.type && e.parameter === t.parameter);
    ...
    (ey.writeRtpDescription = (e, t) => {
      ...
      (n +=
        ...
        " " +
        t.codecs
          .map((e) => (void 0 !== e.preferredPayloadType ? e.preferredPayloadType : e.payloadType))
          .join(" ") +
    ...
    (ey.parseRtpEncodingParameters = (e) => {
      let t;
      const n = [],
      ...
      c.length > 0 && c[0].length > 1 && c[0][0] === a && (t = c[0][1]),
        ...
        0 === n.length && a && n.push({ ssrc: a }); // we support both b=AS and b=TIAS but interpret AS as TIAS.
    ...
    (ey.parseMsid = (e) => {
      let t;
      const n = ey.matchPrefix(e, "a=msid:");
    ...
    (ey.parseSctpDescription = (e) => {
      let t;
      const n = ey.parseMLine(e),
        r = ey.matchPrefix(e, "a=max-message-size:");
      r.length > 0 && (t = parseInt(r[0].substring(19), 10)), Number.isNaN(t) && (t = 65536);
      const i = ey.matchPrefix(e, "a=sctp-port:");
      if (i.length > 0)
        return { port: parseInt(i[0].substring(12), 10), protocol: n.fmt, maxMessageSize: t };
      const o = ey.matchPrefix(e, "a=sctpmap:");
      if (o.length > 0) {
    ...
    (ey.writeSessionBoilerplate = (e, t, n) =>
      "v=0\r\no=" +
      (n || "thisisadapterortc") +
      " " +
    ...
    (ey.getKind = (e) => {
      const t = ey.splitLines(e),
        n = t[0].split(" ");
      return n[0].substring(2);
    }),
    (ey.isRejected = (e) => "0" === e.split(" ", 2)[1]),
    (ey.parseMLine = (e) => {
      const t = ey.splitLines(e),
    ...
    (eg = ey);
  const ew = (({ window: e } = {}, t = { shimChrome: !0, shimFirefox: !0, shimSafari: !0 }) => {
      const n = ((e) => {
          // Returned result object.
          const t = { browser: null, version: null }; // Fail early if it's not a browser
          ...
          return (
            n.mozGetUserMedia
              ...
              : n.webkitGetUserMedia || (!1 === e.isSecureContext && e.webkitRTCPeerConnection) // Chrome, Chromium, Webview, Opera.
      ...
      switch (n.browser) {
        case "chrome":
          ...
          f(
            ...
            (r.browserShim =
              j), // Must be called before shimPeerConnection.
            eT(e, n),
            eR(e, n),
        ...
        case "firefox":
          ...
          f(
            ...
            (r.browserShim =
              W), // Must be called before shimPeerConnection.
            eT(e, n),
            eR(e, n),
        ...
        case "safari":
          ...
          f(
            ...
            (r.browserShim =
              eo), // Must be called before shimCallbackAPI.
            eT(e, n),
            eR(e, n),
            ...
            try {
              ...
              try {
                (n = e.createDataChannel("_PEERJSTEST", { ordered: !0 })),
                  (t.data = !0),
                  (t.reliable = !!n.ordered); // Binary test
                try {
      ...
      _print(e, ...t) {
        ...
        e >= w.All
          ...
          : e >= w.Warnings
            ...
            : e >= w.Errors && console.error("ERROR", ...n);
      }
      constructor() {
  ...
  Object.create && ((eB.prototype = Object.create(null)), new eB().__proto__ || (eA = !1)),
     ...
     */ (eN.prototype.removeAllListeners = function (e) {
      ...
      return (
        e
          ? ((t = eA ? eA + e : e), this._events[t] && eU(this, t))
          : ((this._events = new eB()), (this._eventsCount = 0)),
        this
      );
    }), //
  ...
  class eJ extends ej.EventEmitter {
    start(e, t) {
      ...
      !this._socket &&
        ...
        (this._socket.onopen = () => {
          this._disconnected ||
            (this._sendQueuedMessages(), eO.log("Socket open"), this._scheduleHeartbeat());
        }));
    }
    _scheduleHeartbeat() {
    ...
    _sendHeartbeat() {
      ...
      const e = JSON.stringify({ type: O.Heartbeat });
    ...
    _sendQueuedMessages() {
      ...
      for (const t of ((this._messagesQueue = []), e)) this.send(t);
  ...
  class eV {
    /** Returns a PeerConnection object set up correctly (for data, media). */ startConnection(e) {
      const t = this._startPeerConnection(); // What do we need to do now?
      if (
    ...
    cleanup() {
      ...
      (this.connection.peerConnection =
        null), //unsubscribe from all PeerConnection's events
      ...
      try {
        ...
        try {
          ...
          "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" !==
            e && (t.emitError(E.WebRTC, e), eO.log("Failed to setLocalDescription, ", e));
        }
      } catch (e) {
    ...
    async handleSDP(e, t) {
      ...
      const n = this.connection.peerConnection,
  ...
  class eY extends eH {
    ...
    answer(e, t = {}) {
      ...
      (this._localStream = e),
        t?.sdpTransform && (this.options.sdpTransform = t.sdpTransform),
        this._negotiator.startConnection({ ...this.options._payload, _stream: e }); // Retrieve lost messages stored because PeerConnection not set up.
    ...
    close() {
      this._negotiator && (this._negotiator.cleanup(), (this._negotiator = null)),
        ...
        this.options?._stream && (this.options._stream = null),
    ...
    constructor(e, t, n) {
      super(e, t, n),
        ...
        this._localStream &&
          this._negotiator.startConnection({ _stream: this._localStream, originator: !0 });
    }
  }
  eY.ID_PREFIX = "mc_";
  class eK {
    _buildRequest(e) {
      const t = this._options.secure ? "https" : "http",
  ...
  class eQ extends eq {
    ...
    _sendChunks(e) {
      ...
      for (const e of (eO.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`), t))
        this.send(e, !0);
    }
    constructor(e, t, r) {
      super(e, t, r),
  ...
  class e0 extends eq {
    // Handles a DataChannel message.
    _handleDataMessage({ data: e }) {
      const t = this.parse(this.decoder.decode(e)),
        n = t.__peerData;
      if (n && "close" === n.type) {
        this.close();
        return;
  ...
  class e1 extends eG {
    ...
    _createServerConnection() {
      ...
      return (
        ...
        e.on(M.Disconnected, () => {
          this.disconnected ||
            (this.emitError(E.Network, "Lost connection to server."), this.disconnect());
        }),
        e.on(M.Close, () => {
    ...
    _handleMessage(e) {
      ...
      switch (t) {
        ...
        case O.Offer: {
          ...
          if (
            (t && (t.close(), eO.warn(`Offer received for existing Connection ID:${e}`)),
            n.type === P.Media)
          ) {
            const i = new eY(r, this, { connectionId: e, _payload: n, metadata: n.metadata });
    ...
    call(e, t, n = {}) {
      ...
      const r = new eY(e, this, { ...n, _stream: t });
    ...
    constructor(e, t) {
      ...
      if (
        ...
        (this._lastServerId =
          null), // States.
        (this._destroyed =
          !1), // Connections have been killed
        (this._disconnected =
          !1), // Connection to PeerServer killed but P2P connections still active
        (this._open =
          !1), // Sockets and such are not yet open.
        (this._connections =
        ...
        e && e.constructor === Object
          ...
          : e &&
            (n =
              e.toString()), // Configurize options
        (t = {
          debug: 0,
          host: eM.CLOUD_HOST,
          port: eM.CLOUD_PORT,
